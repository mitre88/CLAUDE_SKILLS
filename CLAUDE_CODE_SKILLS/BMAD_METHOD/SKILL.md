...
### GitHub MCP
SIEMPRE consulta el repositorio oficial antes de implementar:
- `mcp__github__get_file_contents` - Obtener archivos del repo BMAD-METHOD
- `mcp__github__search_code` - Buscar código específico en el repositorio

### Context7
Para documentación actualizada de librerías:
